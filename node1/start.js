...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=C:/besu-network/node1/node1-config.toml --node-private-key-file="${tempPrivateKeyFilePath}" --network-id=1337 --genesis-file=C:/besu-network/genesis.json`;

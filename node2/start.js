...
const account = '0xF3c7C0Acc69A8bBf3D91D2b46DcBCff1d83599fc';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=C:/besu-network/node2/node2-config.toml --node-private-key-file="${tempPrivateKeyFilePath}" --network-id=1337 --genesis-file=C:/besu-network/genesis.json`;

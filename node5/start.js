...
const account = '0x087C492C3882CeBFc1400d8bdB347b2a1725De8C';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=C:/besu-network/node5/node5-config.toml --node-private-key-file="${tempPrivateKeyFilePath}" --network-id=1337 --genesis-file=C:/besu-network/genesis.json`;

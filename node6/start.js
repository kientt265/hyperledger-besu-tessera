...
const account = '0x145dDf6820347293796AC76BDCa177ca338f087E';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=C:/besu-network/node6/node6-config.toml --node-private-key-file="${tempPrivateKeyFilePath}" --network-id=1337 --genesis-file=C:/besu-network/genesis.json`;

...
const account = '0x3b40823fdCace525E82adE94b54910C8F750fff2';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=C:/besu-network/node4/node4-config.toml --node-private-key-file="${tempPrivateKeyFilePath}" --network-id=1337 --genesis-file=C:/besu-network/genesis.json`;
